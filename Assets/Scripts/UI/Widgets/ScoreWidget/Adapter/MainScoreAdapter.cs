...
{
    [UsedImplicitly]
    public sealed class MainScoreAdapter : IInitializable, IFinishable
    {
        private readonly ScoreCounter _counter;
        private readonly ScoreView _view;

        public MainScoreAdapter(ScoreCounter counter, ScoreView view)
        {
            _counter = counter;
            _view = view;
        }
        ...
        {
            _view.UpdateScoreText($"Score: {score}");
        }
    }
}